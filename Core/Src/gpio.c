...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(SPI_slave_CS_GPIO_Port, SPI_slave_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LD4__Green_Led_Pin|LD3_Pin|LD5_Pin|LD6_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = SPI_slave_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SPI_slave_CS_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin PBPin */
  GPIO_InitStruct.Pin = D_Aux_HS_sig_Pin|D_Aux_LS_sig_Pin|D_Shutdown_Contactor_sig_Pin|IMD_fault_sig_Pin
                          |D_Final_Close_sig_Pin|D_charger_detect_sig_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : PDPin PDPin PDPin PDPin */
  GPIO_InitStruct.Pin = LD4__Green_Led_Pin|LD3_Pin|LD5_Pin|LD6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;

...
#define D_IMD_fault_sig_latched_Pin GPIO_PIN_11
#define D_IMD_fault_sig_latched_GPIO_Port GPIOB
...
#define D_BMS_fault_latched_sig_Pin GPIO_PIN_8
#define D_BMS_fault_latched_sig_GPIO_Port GPIOA
...
#define D_Final_Close_Sig_Pin GPIO_PIN_4
#define D_Final_Close_Sig_GPIO_Port GPIOB
